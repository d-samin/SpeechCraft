...
class Exercise2ForSH extends StatefulWidget {
@override
  _ExerciseScreenState createState() => _ExerciseScreenState();
}

class _ExerciseScreenState extends State<Exercise2ForSH> {
  int _seconds = 15;
  Timer? _timer;
          ...
          children: [
                  ...
                  Stack(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          'Округли губы и сделай долгий выдох в ладоши, не надувая щеки',
            ...
            Align(
              ...
              child: Container(
                ...
                child: Center(
                  child: Image.asset('assets/SH/coldSH.png', width: screenWidth * 0.4),
                ),
              ),
            ),
            Positioned(
