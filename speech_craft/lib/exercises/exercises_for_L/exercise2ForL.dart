...
class Exercise2ForL extends StatefulWidget {
@override
  _ExerciseScreenState createState() => _ExerciseScreenState();
}

class _ExerciseScreenState extends State<Exercise2ForL> {
  int _seconds = 15;
  Timer? _timer;
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                ...
                child: Center(
                  child: Image.asset('assets/R/horse_for_R.png', width: screenWidth * 0.4),
                ),
              ),
            ),
            Positioned(
