...
class Exercise4ForL extends StatefulWidget {
@override
  _ExerciseScreenState createState() => _ExerciseScreenState();
}

class _ExerciseScreenState extends State<Exercise4ForL> {
  int _seconds = 15;
  Timer? _timer;
          ...
          children: [
                  ...
                  Stack(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          'Прижми язык к верхнему нёбу, имитируя шапку гриба, напряги язык, задержись на 4-5 раз.',
            ...
            Align(
              ...
              child: Container(
                ...
                child: Center(
                  child: Image.asset('assets/L/mushroomL.png', width: screenWidth * 0.4),
                ),
              ),
            ),
            Positioned(
