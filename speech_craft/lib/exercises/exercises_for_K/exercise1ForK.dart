...
class Exercise1ForK extends StatefulWidget {
@override
  _ExerciseScreenState createState() => _ExerciseScreenState();
}

class _ExerciseScreenState extends State<Exercise1ForK> {
  int _seconds = 15;
  Timer? _timer;
          ...
          children: [
                  ...
                  Stack(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          'Кашляй вслух, а затем шепотом, чтобы добиться чистого звука K',
            ...
            Align(
              ...
              child: Container(
                ...
                child: Center(
                  child: Image.asset('assets/K/coughK.png', width: screenWidth * 0.4),
                ),
              ),
            ),
            Positioned(
