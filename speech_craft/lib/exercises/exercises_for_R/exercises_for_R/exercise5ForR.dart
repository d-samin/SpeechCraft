...
class Exercise5ForR extends StatefulWidget {
@override
  _ExerciseScreenState createState() => _ExerciseScreenState();
}

class _ExerciseScreenState extends State<Exercise5ForR> {
  int _seconds = 15;
  Timer? _timer;
          ...
          children: [
                  ...
                  Stack(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          'Быстро повторяй букву Д, повторение перейдет в вибрацию и даст звук Р',
            ...
            Align(
              ...
              child: Container(
                ...
                child: Center(
                  child: Image.asset('assets/R/Д.png', width: screenWidth * 0.4),
                ),
              ),
            ),
            Positioned(
