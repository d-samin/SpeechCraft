...
import 'package:speech_craft/exercises/exercises_for_R/exercises_for_R_firstCircle/exercise3ForR_1%20.dart';

class Exercise2ForR_1 extends StatefulWidget {
  @override
  _ExerciseScreenState createState() => _ExerciseScreenState();
}

class _ExerciseScreenState extends State<Exercise2ForR_1> {
  int _seconds = 15;
  Timer? _timer;
  ...
  void _goToNextExercise() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => Exercise3ForR_1()),
    );
  }
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
              ...
              child: Center(
                child: Image.asset('assets/horse_for_R.png', width: 200),
              ),
            ),
          ),
