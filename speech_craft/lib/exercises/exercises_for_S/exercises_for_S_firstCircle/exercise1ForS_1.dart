...
import 'package:speech_craft/exercises/exercises_for_S/exercises_for_S_firstCircle/exercise2ForS_1.dart';

class Exercise1ForS_1 extends StatefulWidget {
  @override
  _ExerciseScreenState createState() => _ExerciseScreenState();
}

class _ExerciseScreenState extends State<Exercise1ForS_1> {
  int _seconds = 15;
  Timer? _timer;
  ...
  void _goToNextExercise() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => Exercise2ForS_1()),
    );
  }
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            right: 40,
            child: Text(
              'Посвисти, высунув язычок между зубами',
          ...
          Align(
            ...
            child: Container(
              ...
              child: Center(
                child: Image.asset('assets/S/whistle_for_S.png', width: 200),
              ),
            ),
          ),
