...
class Exercise2ForS extends StatefulWidget {
@override
  _ExerciseScreenState createState() => _ExerciseScreenState();
}

class _ExerciseScreenState extends State<Exercise2ForS> {
  int _seconds = 15;
  Timer? _timer;
          ...
          children: [
                  ...
                  Stack(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          'Изобрази тишину звуком «тсссс», растягивая С в конце',
            ...
            Align(
              ...
              child: Container(
                ...
                child: Center(
                  child: Image.asset('assets/S/shh_for_S.png', width: screenWidth * 0.4),
                ),
              ),
            ),
            Positioned(
