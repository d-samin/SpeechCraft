...
class Exercise1ForS extends StatefulWidget {
@override
  _ExerciseScreenState createState() => _ExerciseScreenState();
}

class _ExerciseScreenState extends State<Exercise1ForS> {
  int _seconds = 15;
  Timer? _timer;
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                ...
                child: Center(
                  child: Image.asset('assets/S/whistle_for_S.png', width: screenWidth * 0.4),
                ),
              ),
            ),
            Positioned(
