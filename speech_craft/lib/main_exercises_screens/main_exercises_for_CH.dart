...
class MainExercisesScreenForCH extends StatelessWidget {
  final String disorderName;

  MainExercisesScreenForCH({required this.disorderName});
      ...
      Positioned(
        ...
        child: GestureDetector(
          onTap: () {
            // Navigator.push(
              // context,
              // MaterialPageRoute(builder: (context) => PatternsForCH()), 
            // );
          },
          child: Container(
            height: 100,
