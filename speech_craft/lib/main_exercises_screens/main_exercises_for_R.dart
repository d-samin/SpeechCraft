...
import 'package:speech_craft/exercises/exercises_for_R/exercises_for_R_firstCircle/exercise1ForR_1.dart';
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Exercise1ForR_1()),
                );
              },
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                // Navigator.push(
                //   context,
                //   MaterialPageRoute(builder: (context) => Exercise1ForR_2()),
                // );
              },
