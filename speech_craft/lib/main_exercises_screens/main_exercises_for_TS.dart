...
class MainExercisesScreenForTS extends StatelessWidget {
  final String disorderName;

  MainExercisesScreenForTS({required this.disorderName});
      ...
      Positioned(
        ...
        child: GestureDetector(
          onTap: () {
            // Navigator.push(
            //   context,
            //   MaterialPageRoute(builder: (context) => PatternsForTS()), 
            // );
          },
          child: Container(
            height: 100,
