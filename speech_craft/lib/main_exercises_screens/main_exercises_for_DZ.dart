...
class MainExercisesScreenForDZ extends StatelessWidget {
  final String disorderName;

  MainExercisesScreenForDZ({required this.disorderName});
      ...
      Positioned(
        ...
        child: GestureDetector(
          onTap: () {
            // Navigator.push(
            //   context,
            //   MaterialPageRoute(builder: (context) => PatternsForDZ()), 
            // );
          },
          child: Container(
            height: 100,
