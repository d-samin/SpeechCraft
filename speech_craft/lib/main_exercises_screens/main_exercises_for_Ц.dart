...
import 'package:speech_craft/exercises/exercises_for_%D0%A6/exercise1ForTC.dart';
import 'package:speech_craft/patters/patters_for_%D0%A6/PattersForTC.dart';

class MainExercisesScreenForTC extends StatelessWidget {
  final String disorderName;

  MainExercisesScreenForTC({required this.disorderName});
      ...
      Positioned(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => PattersForTC()), 
            );
          },
          child: Container(
            height: 100,
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Exercise1ForTC()),
                );
              },
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                // Navigator.push(
                //   context,
                //   MaterialPageRoute(builder: (context) => Exercise2ForTC()),
                // );
              },
