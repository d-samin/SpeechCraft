...
import 'package:speech_craft/exercises/exercises_for_L/exercise1ForL.dart';
import 'package:speech_craft/exercises/exercises_for_L/exercise2ForL.dart';
import 'package:speech_craft/exercises/exercises_for_L/exercise3ForL.dart';
import 'package:speech_craft/exercises/exercises_for_L/exercise4ForL.dart';
import 'package:speech_craft/patters/patters_for_L/PattersForL.dart';

class MainExercisesScreenForL extends StatelessWidget {
  final String disorderName;

  MainExercisesScreenForL({required this.disorderName});
      ...
      Positioned(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => PattersForL()), 
            );
          },
          child: Container(
            height: 100,
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Exercise1ForL()),
                );
              },
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Exercise2ForL()),
                );
              },
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Exercise3ForL()),
                );
              },
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Exercise4ForL()),
                );
              },
