...
import 'package:speech_craft/exercises/exercises_for_K/exercise1ForK.dart';
import 'package:speech_craft/exercises/exercises_for_K/exercise2ForK.dart';
import 'package:speech_craft/patters/patters_for_K/PattersForK.dart';

class MainExercisesScreenForK extends StatelessWidget {
  final String disorderName;

  MainExercisesScreenForK({required this.disorderName});
      ...
      body: Stack(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => PattersForK()), 
            );
          },
          child: Container(
            height: 100,
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Exercise1ForK()),
                );
              },
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Exercise2ForK()),
                ); 
              },
